...
export default function Lanyard({
    ...
    // Use cameraDistance if provided
    const adjustedPosition = [position[0], position[1], cameraDistance];
        ...
        <div className="relative z-0 w-full h-screen flex justify-center items-center transform scale-100 origin-center">
            ...
            >
                ...
                <Physics gravity={gravity} timeStep={isMobile ? 1 / 30 : 1 / 60}>
                    <Band isMobile={isMobile} onInteract={onInteract} />
                </Physics>
...
function Band({ maxSpeed = 50, minSpeed = 0, isMobile = false, onInteract }) {
